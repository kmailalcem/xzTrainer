...
class FloatingActionButton: UIButton {
    ...
    override var isHighlighted: Bool {
        didSet {
            if isHighlighted {
                backgroundColor = #colorLiteral(red: 0.1490196078, green: 0.4039215686, blue: 0.5803921569, alpha: 1)
                imageView?.tintColor = #colorLiteral(red: 1, green: 1, blue: 1, alpha: 1)
            } else {
                if !isSelected {
                    backgroundColor = #colorLiteral(red: 1.0, green: 1.0, blue: 1.0, alpha: 1.0)
                    imageView?.tintColor = #colorLiteral(red: 0.1490196078, green: 0.4039215686, blue: 0.5803921569, alpha: 1)
                }
            }
        }
    }
    ...
    override var isSelected: Bool {
        didSet {
            if isSelected {
                ...
                imageView?.tintColor = #colorLiteral(red: 0.1342299879, green: 0.4006600678, blue: 0.5895091891, alpha: 1)
            }
        }
    }
}
